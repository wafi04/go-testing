...
func (c *fileServiceClient) UploadFile(ctx context.Context, in *FileUploadRequest, opts ...grpc.CallOption) (*FileUploadResponse, error) {
...
func (UnimplementedFileServiceServer) UploadFile(context.Context, *FileUploadRequest) (*FileUploadResponse, error) {
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/proto/files/files.proto",
}
